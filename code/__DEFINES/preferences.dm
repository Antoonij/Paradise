...
#define PREFTOGGLE_3_TWITCH_FILTER	 			(1<<4) // 16

#define TOGGLES_3_TOTAL                       	23 // If you add or remove a preference toggle above, make sure you update this define with the total value of the toggles combined.
